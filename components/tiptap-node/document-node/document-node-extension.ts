 ...
 *    Without this, ProseMirror's schema fitter would create an
 *    empty heading and push all pasted blocks into the body.
 */
      ...
      new Plugin({
        ...
        props: {
          handlePaste: (view, _event, slice) => {
            ...
            // Only intercept full-document replacements (AllSelection /
            // NodeSelection on the heading) with complete blocks.
            // openStart > 0 means inline merge — ProseMirror handles that fine.
            ...
            // Textblocks (paragraph, code_block) carry inline content that
            // is compatible with heading — use it directly to keep marks.
            // Non-textblocks (blockquote, list) get flattened to plain text.
